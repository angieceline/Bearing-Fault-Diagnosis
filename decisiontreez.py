...
plt.title("2D PCA Projection of Bearing Fault Data (Decision Tree)")
...
plot_tree(tree_clf, filled=True, feature_names=X.columns, class_names=label_encoder.classes_, rounded=True)
